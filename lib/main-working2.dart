      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageFinished: (url) async {
            ...
            // If we loaded the real URL successfully → we're online
            if (url.startsWith('http') && url.contains('192.168.1.5')) {
              setState(() {
                _offlineMode = false;
                _reconnecting = false;
              });
            }
            // If somehow onPageFinished fired but we're still trying to reconnect → check again
